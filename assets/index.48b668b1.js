...
`;const i=b.exports.jsx,v=b.exports.jsxs,D=()=>{const[t,e]=l.exports.useState(A);return v("div",{className:"Wrapper",children:[i("div",{className:"Container",children:i("textarea",{value:t,onChange:s=>{e(s.target.value)},spellCheck:"false"})}),i("div",{className:"Container Output",children:i(y,{value:t})})]})};T.render(v(O.StrictMode,{children:[" ",i(D,{})," "]}),document.getElementById("root"));
